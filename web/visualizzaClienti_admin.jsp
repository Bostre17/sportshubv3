...
<html>
<head>
  <title>VisualizzaClientiAdmin</title>
  <meta charset="UTF-8">
...
<%
	...
	{
		Log.writeLog("admin", LocalDateTime.now(), "Visualizza i Clienti");
...
%>
    <div class="elenco">
                ...
                <form action="RimuoviCliente"> 
                	<input type="hidden" name="nomeCliente" value="<%= cl.getUsername() %>">      
                	<input id="btn" type="submit" value="Rimuovi" size="40"/>
                </form>
                <form action="SbloccaCliente"> 
                	<input type="hidden" name="nomeCliente" value="<%= cl.getUsername() %>">      
					<%
						String valoreBottone="";
						if(cl.getStato().equals("Attivo")){
							valoreBottone="Blocca";
						}
						else{
							valoreBottone="Sblocca";
						}
					%>
					
					<input id="btn" type="submit" value="<%= valoreBottone %>" size="40">
